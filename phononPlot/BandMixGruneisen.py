...
def AdjacentMixPictures():
    ...
    ax10 = plt.subplot2grid((2, 6), (0, 0), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/PRI/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    frequencies, eigenvectors = PG.readGruneisenYaml()
    ...
    ax10.set_xticks(distance_HighlySymmetricPath)
    ax10.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax10.set_ylim(-5, 25)
    ax10.set_yticks(np.arange(-5, 26, 5))
    ax10.set_yticklabels(np.arange(-5, 26, 5), fontsize='18')
    ax10.tick_params(labelsize='18')
    ax10.text(0.0, -0.75 * 5, '(a)', fontsize='18')
    ax10.set_ylabel('$\omega(THz)$', fontsize='18')

    ax11 = plt.subplot2grid((2, 6), (0, 2), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/SnO2_10136/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    frequencies, eigenvectors = PG.readGruneisenYaml()
    ...
    ax11.set_xticks(distance_HighlySymmetricPath)
    ax11.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax11.set_ylim(-5, 25)
    ax11.set_yticks(np.arange(-5, 26, 5))
    ax11.set_yticklabels('', fontsize='18')
    ax11.tick_params(labelsize='18')
    ax11.text(0.0, -0.75 * 5, '(b)', fontsize='18')
    # ax11.set_ylabel('$\omega(THz)$', fontsize='18')

    #
    ax12 = plt.subplot2grid((2, 6), (0, 4), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/SnO2_301/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    frequencies, eigenvectors = PG.readGruneisenYaml()
    ...
    ax12.set_xticks(distance_HighlySymmetricPath)
    ax12.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax12.set_ylim(-5, 25)
    ax12.set_yticks(np.arange(-5, 26, 5))
    ax12.set_yticklabels('', fontsize='18')
    ax12.tick_params(labelsize='18')
    ax12.text(0.0, -0.75 * 5, '(c)', fontsize='18')
    # ax12.set_ylabel('$\omega(THz)$', fontsize='18')

    ax20 = plt.subplot2grid((2, 6), (1, 0), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/PRI/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    ...
    ax20.set_xticks(distance_HighlySymmetricPath)
    ax20.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax20.set_ylim(-6, 4)
    ax20.set_yticks(np.arange(-6, 5, 2))
    ax20.set_yticklabels(np.arange(-6, 5, 2), fontsize='18')
    ax20.tick_params(labelsize='18')
    ax20.text(0.0, -0.95 * 6, '(d)', fontsize='18')
    ax20.set_ylabel('Gruneisen parameter', fontsize='18')

    ax21 = plt.subplot2grid((2, 6), (1, 2), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/SnO2_10136/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    ...
    ax21.set_xticks(distance_HighlySymmetricPath)
    ax21.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax21.set_ylim(-6, 4)
    ax21.set_yticks(np.arange(-6, 5, 2))
    ax21.set_yticklabels('', fontsize='18')
    ax21.tick_params(labelsize='18')
    ax21.text(0.0, -0.95 * 6, '(e)', fontsize='18')
    # ax11.set_ylabel('$\omega(THz)$', fontsize='18')

    #
    ax22 = plt.subplot2grid((2, 6), (1, 4), colspan=2, rowspan=1)
    inputpath = 'F:/2020/SnO2/SnO2_301/PHO'
    PB = PhononyBand(inputpath + '/orig', HighlySymmetricPath)
    Natoms, kDistance, distance_HighlySymmetricPath = PB.readBandYaml()
    PG = PhononyGruneisen(inputpath)
    ...
    ax22.set_xticks(distance_HighlySymmetricPath)
    ax22.set_xticklabels(OrderedDict(
        HighlySymmetricPath).keys(), fontsize='18')
    ax22.set_ylim(-6, 4)
    ax22.set_yticks(np.arange(-6, 5, 2))
    ax22.set_yticklabels('', fontsize='18')
    ax22.tick_params(labelsize='18')
    ax22.text(0.0, -0.95 * 6, '(f)', fontsize='18')
    # ax12.set_ylabel('$\omega(THz)$', fontsize='18')
